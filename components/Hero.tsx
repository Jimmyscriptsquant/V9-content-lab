...
const Hero = () => {
  return (
    <section className="max-w-7xl mx-auto bg-base-100 flex flex-col items-center justify-center gap-16 px-8 py-16 lg:py-28">
      <div className="flex flex-col gap-8 items-center justify-center text-center max-w-4xl">
        <div className="badge badge-primary badge-outline gap-2 py-3 px-4 text-sm font-medium">
          Now with OpenClaw &amp; open-source model support
        </div>

        <h1 className="font-extrabold text-4xl lg:text-7xl tracking-tight">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-4">
          ...
          <Link href="/#features" className="btn btn-outline btn-lg px-8">
            See How It Works
          </Link>
        </div>
      ...
      <div className="w-full max-w-3xl">
        <div className="mockup-code bg-neutral text-neutral-content shadow-2xl text-sm">
